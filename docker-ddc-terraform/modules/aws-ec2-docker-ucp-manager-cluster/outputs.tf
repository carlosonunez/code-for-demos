output "ucp_manager_lb_id" {
  count = "${var.var.number_of_aws_availability_zones_to_use <= 1 ? 1 : 0}"
...
output "ucp_manager_lb_id" {
  count = "${var.var.number_of_aws_availability_zones_to_use == 2 ? 1 : 0}"
...
output "ucp_manager_lb_id" {
  count = "${var.var.number_of_aws_availability_zones_to_use == 3 ? 1 : 0}"
